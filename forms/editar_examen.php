  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Editar Exámen</h2>
        <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="buscar_examen.php">Buscar Exámen</a>
            <a style="color: #000000" href="listar_examenes.php?id=<?php echo $idpac ?>">Lista Exámenes</a>
            <a style="color: #000000" href="editar_examen.php?idc=<?php echo $idcab; ?>&idp=<?php echo $idpac; ?>">Editar Exámen</a>
        </div>
      </div>
    </div>
  </div>
...
<script>
    function tipep(){
        ...
        if (tipoa == 1) {
            ...
            <div class="checkbox">
                <h2 style="background-color:#CCEEFF; margin-left: 1px; padding: 5px 10px 5px 15px;">BIOQUÍMICOS</h2>
