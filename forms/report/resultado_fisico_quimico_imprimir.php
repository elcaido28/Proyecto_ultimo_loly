...
$consulta22=mysqli_query($con,"SELECT * FROM cabecera_resultado CR INNER JOIN detalle_resultado DR ON CR.cabecera_resultado_id=DR.cabecera_resultado_id INNER JOIN cabecera_examen CE ON CR.cabecera_exa_id=CE.cabecera_exa_id WHERE CR.cabecera_exa_id='$idcabecera' AND CR.cabecera_tipo_formato='2' and detalle_resultado_seccion='Fisico-Quimico'");
...
$y=$pdf->GetY();
 $pdf->SetXY(20,$y);
    ...
    if($row6['detalle_resultado_tipoexa']=="Null"){
        ...
        $pdf->Cell(70,6,utf8_decode(strtoupper($row6['detalle_resultado_tipoexa'].":")),0,0,'L');
    }
  ...
  if ($cuenta>1) {
    ...
    $pdf->Cell(50,6,utf8_decode($row6['detalle_resultado_resul']),0,1,'L');
  }
}
