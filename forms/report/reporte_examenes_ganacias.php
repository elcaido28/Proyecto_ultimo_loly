...
$consulta=mysqli_query($con,"SELECT * FROM cabecera_examen C INNER JOIN paciente P ON C.id_paciente=P.id_paciente  where C.estado_exa_id='1' and C.tipo_pago='1' ".$query." ");
