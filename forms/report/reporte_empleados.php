...
$pdf->SetFillColor(55, 144, 191);
 ...
 // $pdf->Cell(10,10,utf8_decode('Fecha'),1,0,'C',true);
$pdf->Cell(72,10,utf8_decode('Empleado'),1,0,'C',true);
$pdf->Cell(25,10,utf8_decode('Cédula'),1,0,'C',true);
$pdf->Cell(25,10,utf8_decode('Teléfono'),1,0,'C',true);
$pdf->Cell(43,10,utf8_decode('Cargo'),1,0,'C',true);
...
$pdf->Cell(72,10,utf8_decode($row5['nombres']." ".$row5['apellidos']),1,0,'C');
$pdf->Cell(25,10,utf8_decode($row5['cedula']),1,0,'C');
$pdf->Cell(25,10,utf8_decode($row5['telefono']),1,0,'C');
$pdf->Cell(43,10,utf8_decode($row5['nombre_rol']),1,0,'C');
