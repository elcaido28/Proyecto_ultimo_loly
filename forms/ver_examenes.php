  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Detalle del Examen</h2>
        <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="buscar_examenes.php">Buscar Examen</a>
            <!-- <a href="https://www.laboratoriololy.com/forms/buscar_examenes.php">Buscar Examen</a> -->
            <a style="color: #000000" href="ver_examenes.php?idp=<?php echo $idpac; ?>&idc=<?php echo $idcab; ?>">Detalle Examen</a>
        </div>
      </div>
    </div>
  </div>
