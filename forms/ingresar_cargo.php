    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">Agregar Cargo</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_cargo.php">Agregar Cargo</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
        <form class="login100-form validate-form" method="post" action="app/guardarRol.php" name="formix" id="formix"onsubmit=" return fun_insertar()">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
            ...
            <input class="input100" type="text" name="rol" id="rol" required placeholder="Ej: Empleado">
              ...
              <tr>
                ...
                <td>
                  <div class="cont_tbn_tb">
                    ...
                    <?php }else{ ?>
                    <button type="button" class="elim eliminar m-l-5" title="Eliminar" id="<?php echo $row['id_rol'] ?>" name="button"><i class="far fa-trash-alt" id="<?php echo $row['id_rol'] ?>"> </i></button>
                    <?php } ?>
                  </div>
                </td>
              </tr>
...
Toast.fire({
  icon: 'info',
  title: 'Ya existe un Cargo similar'
})
}
ejecutarEjemplo();
</script>
