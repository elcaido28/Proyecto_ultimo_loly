  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Ingresar Examen</h2>
        <div class="page_link">
          <a style="color: #000000" href="inicio.php">Inicio</a>
          <a style="color: #000000" href="ingreso_examen.php">Ingresar Examen</a>
          <a style="color: #000000" href="registro_examen.php?id=<?php echo $idpac; ?>">Registrar Examen</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="parados">
                ...
                <div class="col-md-3">
                    <div class="wrap-input100 m-b-23 m-r-12">
                        ...
                        <input class="input100" type="text" name="precio" id="precio" onkeypress="return valida(event)" maxlength="6" placeholder="$" required>
                        <span class="focus-input100" data-symbol=""></span>
                    </div>
                </div>
                <div class="col-md-2">
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
            ...
            <div class="parados">
                ...
                <div class="wrap-input100 m-b-23">
                    ...
                    <input class="input100" type="text" name="abono" id="abono" maxlength="6" placeholder="$" onkeypress="return valida(event)" disabled>
                    <span class="focus-input100" data-symbol=""></span>
                </div>
            </div>
    ...
    function tipep(){
        ...
        if (tipoa == 1) {
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" id="Hemotocrito" name="Name[]" value="Hematócrito">
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" id="HT" name="Name[]" value="T. Sangría">
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" id="VDT" name="Name[]" value="V.D.R.I. tantit">
                ...
                <input type="checkbox" id="raTurb" name="Name[]" value="R.A. TEST (Turb.)">
                <label for="raTurb">R.A. TEST (Turb.) </label>
                <input type="checkbox" id="calculasLe" name="Name[]" value="Celulas L.E.">
                ...
                <input type="checkbox" id="vdrl" name="Name[]" value="V.D.R.L cuali">
                <label for="vdrl">V.D.R.L cuali</label>
                <input type="checkbox" id="vdrlct" name="Name[]" value="V.D.R.L cuant">
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" name="Name[]" id="checoli" value="CHE (Colinesterasa)">
                ...
                <input type="checkbox" name="Name[]" id="fosfalcalina" value="Fosf. Alcalina">
                ...
                <input type="checkbox" name="Name[]" id="fosfacidaprostatica" value="Fosfat. acid. prost.">
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" name="Name[]" id="Seroglogulina" value="Seroglobulina">
            ...
            <div class="checkbox">
                ...
                <!--<input type="checkbox" name="Name[]" id="Fosfatalcal" value="Fosf. Alcalina">-->
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" name="Name[]" id="UrinalisisEMOFQS" value="Urinálisis EMO (F.Q.S.)">
                <label for="UrinalisisEMOFQS">Urinálisis EMO (F.Q.S.)</label>

                <input type="checkbox" name="Name[]" id="Albumina24h" value="Albúmina 24h">
                <label for="Albumina24h">Albúmina 24h</label>

                <input type="checkbox" name="Name[]" id="AlbuminaOcasional" value="Albúmina Ocasional">
                ...
                <input type="checkbox" name="Name[]" id="Embarazo" value="Embarazo en Orina">
                ...
                <input type="checkbox" name="Name[]" id="SodioOcacional" value="Sodio Ocasional">
                ...
                <input type="checkbox" name="Name[]" id="orinafqs" value="Orina FQS">
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" name="Name[]" id="OxiuroaTecGraham" value="Oxiuros Tec. Graham">
            ...
            <div class="checkbox">
                ...
                <!--<input type="checkbox" name="Name[]" id="entrosedimentacion" value="Eritrosedimentación">-->
                ...
                <!--<input type="checkbox" name="Name[]" id="fibrinogino" value="Fibrinógeno">-->
            ...
            <div class="checkbox">
                ...
                <input type="checkbox" name="Name[]" id="CalcioLonico" value="Calcio Iónico">
            ...
            <div class="checkbox">
                ...
                <div class="row" style="display: flex;">
                    <div class="col-md-4">
                        ...
                        <input type="checkbox" name="Name[]" id="Clamudia" value="Clamidia">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="checkbox" name="Name[]" id="lga" value="IgA">
                        <label for="lga">IgA</label>

                        <input type="checkbox" name="Name[]" id="lge" value="IgE">
                        ...
                        <input type="checkbox" name="Name[]" id="lgg" value="IgG">
                        <label for="lgg">IgG</label>
                    </div>

                    <div class="col-md-4">
                        <input type="checkbox" name="Name[]" id="lgm" value="IgM">
                        ...
                        <input type="checkbox" name="Name[]" id="transferina" value="Transferrina">
                        <label for="transferina">Transferrina</label>

                        <input type="checkbox" name="Name[]" id="transferinas" value="Transferrina Saturación">
