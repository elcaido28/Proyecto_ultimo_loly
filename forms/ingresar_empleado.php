    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">Agregar Empleado</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_empleado.php">Ingresar Empleado</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <form class="login100-form validate-form" method="post" action="app/guardarEmpleado.php" name="formix" id="formix"> 
          ...
          <div class="parados">
            <div class="wrap-input100 validate-input m-b-23 m-r-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="nombres" id="nombres" required onkeypress="return soloLetras(event)" placeholder="Ej: Carlos Andres" onpaste>
  ...
  if(valr!=""){
    buscar_cedula(valr);
            ...
            <div class="wrap-input100 validate-input m-b-23 m-l-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="celular" id="celular" placeholder="Ej: 0912345678" maxlength="10" onchange="validarCelular()" onkeypress="return valida(event)" required>
              <span class="focus-input100" data-symbol="&#xf2d7;"></span>
            </div>
          </div>
          ...
          <div class="parados">
            <div class="wrap-input100 validate-input m-b-23 m-r-10" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="telefono" id="telefono" placeholder="Ej: 2502729" maxlength="7" onchange="validarTelefono()" onkeypress="return valida(event)" required>
              <span class="focus-input100" data-symbol="&#xf2bb;"></span>
            </div>
<script>
$(buscar_correo());
    ...
    buscar_correo(valr);
            ...
            <div class="wrap-input100 m-b-23 m-l-10">
              <span class="label-input100">Cargo (*)</span>
                  <select class="input100"  name="rol" id="rol" onchange="seleccionPerfil()" required>
                    <option value="">-</option>
                  <?php
      ...
      <div class="table-responsive">
              <div class="cont_tabla">
                <table class="tabla" >
                    ...
                    <tr>
                    <?php
                      $consulta=mysqli_query($con,"SELECT * from empleado E inner join rol R on E.id_rol=R.id_rol WHERE E.id_estado='1' AND E.id_empleado>'1'");
                      while($row=mysqli_fetch_array($consulta)){
                    ?>
                      <td><?php echo $row['nombres']." ".$row['apellidos']; ?> </td>
                      <td><?php echo $row['correo']; ?> </td>
                      <td><?php echo $row['nombre_rol']; ?> </td>
                      <td><div class="cont_tbn_tb"> <a href="asignar_usuario.php?ide=<?php echo $row['id_empleado'] ?>"><button type="button" title="Asignar Usuario" class="modificar" name="button"><i class="far fa-share-square"></i></button></a></div> </td>
                      <td>
                          <div class="cont_tbn_tb">
                            ...
                            <button type="button" class="eliminar m-l-5" title="Desactivar" id="<?php echo $row['id_empleado'] ?>" name="button" id="elim"><i class="fas fa-user-slash" id="<?php echo $row['id_empleado'] ?>"></i>
                            </button>
                          </div>
                      </td>
                    </tr>
...
Toast.fire({
  icon: 'warning',
  title: 'Empleado NO Guardado, Nombres y apellidos ya registrados'
})
}
ejecutarEjemplo();
</script>
