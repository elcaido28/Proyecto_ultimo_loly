  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Restaurar Empleados</h2>
        <div class="page_link">
          <a style="color: #000000" href="inicio.php">Inicio</a>
          <a style="color: #000000" href="restaurar_empleado.php">Restaurar Empleados</a>
        </div>
      </div>
    </div>
  </div>
                        ...
                        ?>
                            ...
                            <td>
                                <div class="cont_tbn_tb">
                                    ...
                                    <button type="button" class="elim eliminar m-l-5" title="Eliminar" id="<?php echo $row3['id_empleado'] ?>" name="button"><i class="far fa-trash-alt" id="<?php echo $row3['id_empleado'] ?>"> </i></button>
                                    </button>
                                </div>
...
$('.elim').click(function(e){
  ...
  swalWithBootstrapButtons.fire({
    ...
    if (result.value) {
      document.location.href="app/eliminaEmpleado.php?id="+id_empl;
    } else if (
      /* Read more about handling dismissals below */
      result.dismiss === Swal.DismissReason.cancel
    ) {
