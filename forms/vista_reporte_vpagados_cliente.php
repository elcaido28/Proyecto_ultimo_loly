      ...
      <div class="container">
        <div class="banner_content text-left">
          ...
          <div class="page_link">
            ...
            <a style="color: #000000" href="vista_reporte_vpagados_cliente.php">Reporte Pagos por Paciente</a>
          </div>
        </div>
      </div>
    </div>
...
<?php
  ...
  if($result){
    while ($row = mysqli_fetch_array($result)) {
      $equipos = utf8_encode($row['identificacion']."-".$row['nombres']." ".$row['apellidos']);
