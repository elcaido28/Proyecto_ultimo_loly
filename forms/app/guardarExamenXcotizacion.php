<?php
	...
	$obtener = mysqli_query($con,"UPDATE cabecera_cotizacion SET id_estado='2' WHERE id_cabecera_cotizacion='$idcot'") or die ("erro".mysqli_error());
