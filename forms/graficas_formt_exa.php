    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">GRÁFICA DE TIPO DE EXÁMENES</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="graficas_formt_exa.php">Gráfica de Exámenes por Formato</a>
          </div>
        </div>
      </div>
    </div>
...
$consulta1=mysqli_query($con,"SELECT cabecera_tipo_formato, COUNT(cabecera_resultado_id) num ,formato_nombre FROM cabecera_resultado R inner join tipo_formato F on F.formato_id=R.cabecera_tipo_formato ".$query." GROUP BY R.cabecera_tipo_formato  ");
 while($row1=mysqli_fetch_array($consulta1)){
   $t_ex=utf8_decode($row1['formato_nombre']);
   $n_ex=$row1['num'];
?>
