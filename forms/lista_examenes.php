  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Lista de Exámenes</h2>
        <div class="page_link">
          <a style="color: #000000" href="inicio.php">Inicio</a>
          <a style="color: #000000" href="buscar_examenes.php">Buscar Exámenes</a>
           <a style="color: #000000" href="https://www.laboratoriololy.com/forms/buscar_examenes.php" class="">Lista de Exámenes</a> 
...
<div class="container-login100" style="background: #B8E1F7; margin-top: -50px;">
    <div class="wrap-login1000 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
      ...
      <div class="parados">
        <div class="wrap-input100 validate-input m-b-23 m-l-10" data-validate = "Nombre es requerido">
          <span class="label-input100" style="font-size: 16px;">Exámenes</span>
        </div>
      </div>
<style>
  .liazul{
