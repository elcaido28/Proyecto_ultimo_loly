...
<style>
  ...
  .mlogo{
    ...
    <div class="mlogo">
      <a href="inicio.php"><img src="../img/labo.png"  width="75" height="80" alt="" style="margin-right: 20px;"></a> <h4><?php echo $rol.": ".$nombre; ?> </h4>
    </div>
                    ...
                    <ul >
                      ...
                      <li >
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="#">RESPALDAR <i class="fas fa-caret-right" style="margin-left: 3px;"></i></a>
                            <ul>
                              <li>
                                <a href="backupPHP/pasaporaqui.php" onclick="mensajya()">B.D.</a>
                              </li>
                            </ul>
                          </li>
                        </ul>
                  ...
                  <li>
                    <a href="" >COTIZACIÓN</a>
                     <ul >
                      ...
                      <li >
                         <a  href="buscar_cotizacion.php">BUSCAR</a>
                      </li>
                    </ul>
                  </li>
<?php } ?>
...
<script>
  function mensajya(){
    ...
    Toast.fire({
      icon: 'info',
      title: 'Descargando Base de Datos, Espere..'
    })
  }
</script>