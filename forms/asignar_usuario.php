...
?>
  <!--================ Banner Area =================-->
  <section class="banner_area" style="padding: 100px 0px 0px 0px;">
    <div class="d-flex align-items-center" style="height: 70px; background: #b4dcf2;"> <!-- banner_inner -->
      <div class="container">
        <div class="banner_content text-left" style="height: 50px; padding-top: 12px;">
          <!-- <h2>Asignar Usuario</h2> -->
          <div class="page_link">
            <a href="inicio.php" style="color: #000000">Inicio</a>
            <i class="fas fa-arrow-right" style="margin-right: 5px; margin-left: 5px; color: white"></i>
            <a style="color: #000000" href="ingresar_empleado.php" style="color: white;">Ingresar Empleado</a>
            <i class="fas fa-arrow-right" style="margin-right: 5px; margin-left: 5px; color: white"></i>
            <a style="color: #000000" href="asignar_usuario.php?ide=<?php echo $id_emp; ?>" style="color: white;">Asignar Usuario</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-login100" style="background: #B8E1F7; margin-top: -50px;">
      <div class="wrap-login600 p-l-55 p-r-55 p-t-25 p-b-20 m-b-20">
        ...
        <form class="login100-form validate-form" method="post" action="app/guardarUsuario.php?ide=<?php echo $id_emp; ?>" name="formix" id="formix"> 
          ...
          <div class="parados" style="margin-top: -30px;">
