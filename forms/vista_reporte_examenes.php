      ...
      <div class="container">
        <div class="banner_content text-left">
          ...
          <div class="page_link">
            ...
            <a style="color: #000000" href="vista_reporte_examenes.php">Reporte Exámenes</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
        <form class="login100-form validate-form" method="post" action="report\reporte_examenes.php" name="formix" id="formix" target="_blank">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="wrap-input40 validate-input m-b-23" data-validate = "Nombre es requerido">
            ...
            <input class="input40" type="date" name="fin" id="fecha2" onblur="validar_fecha2(this.value);">
          </div>
        </div><br>
          <div class="m-b-23 m-l-10" >
                <select class="input100 espacio_combo"  name="tipo_examen">
                  ...
                  <option value="2">Examen Físico - Químico de Orina</option>
                  ...
                  <option value="6">Examen Biometría Hemática</option>
                </select>
          </div>
          <br><br>
