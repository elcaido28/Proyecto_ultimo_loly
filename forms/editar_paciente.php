    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container" >
        <div class="banner_content text-left">
          <h2 style="color: #000000">Editar Paciente</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="busqueda_paciente.php">Buscar Paciente</a>
            <a style="color: #000000" href="editar_paciente.php?id=<?php echo $id_paciente; ?>">Editar Paciente</a>
          </div>
        </div>
      </div>
    </div>
    ...
    alert('Fecha Incorrecta');
          ...
          <div class="parados">
            <div class="wrap-input100 validate-input m-b-23 m-r-15" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="celular" id="celular" value="<?php echo $row['celular']; ?>" maxlength="10" onchange="validarCelular()" onkeypress="return valida(event)" placeholder="Ej: 0912345678" required>
              <span class="focus-input100" data-symbol="&#xf2d7;"></span>
            </div>
            <div class="wrap-input100 validate-input m-b-23 m-r-15" data-validate = "Nombre es requerido">
              <span class="label-input100">Teléfono</span>
              <input class="input100" type="text" name="telefono" value="<?php echo $row['telefono']; ?>" id="telefono" onchange="validarTelefono()" onkeypress="return valida(event)" maxlength="7" required placeholder="Ej: 2502729">
              <span class="focus-input100" data-symbol="&#xf2bb;"></span>
            </div>
            <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
