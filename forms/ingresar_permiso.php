    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">Agregar Permiso</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_permiso.php">Agregar Permiso</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 m-b-50">
        <form class="login100-form validate-form" method="post" action="app/guardarPerfil.php" name="formix" id="formix" onsubmit=" return fun_insertar()">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
            ...
            <input class="input100" type="text" name="perfil" id="perfil" placeholder="Ej: Administrador" required>
              ...
              <div class="cont_tabla">
                <table class="tabla" >
                    ...
                    ?>
                      ...
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd==1){ echo $imagen; }else{ echo $imagen2; } ?>" alt=""> </div> </td>
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd==1){ echo $imagen; }else{ echo $imagen2; } ?>"> </div> </td>
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd<=1 || $asd>=3){ echo $imagen; }else{ echo $imagen2; } ?>"> </div> </td>
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd>0){ echo $imagen; }else{ echo $imagen2; } ?>"> </div> </td>
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd>0){ echo $imagen; }else{ echo $imagen2; } ?>"> </div> </td>
                      <td> <div class="cont_tbn_tb"> <img src="images/<?php if($asd==1 || $asd==2){ echo $imagen; }else{ echo $imagen2; } ?>"> </div> </td>
                      <td>
                          <div class="cont_tbn_tb">
                            ...
                            <?php if($asd==1 || $asd==2){ ?> 
                            <button type="button" class="eliminar m-l-5" title="No se puede Eliminar" onclick="noSePuede()"><i class="far fa-trash-alt" ></i></button>
                            <?php }else{ ?>
                            <button type="button" class="elim eliminar m-l-5" title="Eliminar" id="<?php echo $row['id_perfil'] ?>" name="button"><i class="far fa-trash-alt" id="<?php echo $row['id_perfil'] ?>"> </i></button>
                            <?php } ?>
                          </div>
                      </td>
                    </tr>
...
Toast.fire({
  icon: 'info',
  title: 'Ya existe un Permiso similar'
})
}
ejecutarEjemplo();
</script>
