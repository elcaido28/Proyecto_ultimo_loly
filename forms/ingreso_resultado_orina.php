...
function agregar2() {
  ...
  b2 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion3[]' id='pl"+contLin2+"' value=''></div></div>";

  b2 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion3[]' id='plr"+contLin2+"' value=''></div></div>";
...
//   document.getElementById(idcajadt).value=cont_valor;
//   document.getElementById(idcajadtr).value=cont_valorr;
 if(contLin2>1){
     var conj=parseInt(contLin2)-1;
...
function agregar3() {
  ...
  b3 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='pl"+contLin3+"'></div></div>";

  b3 += "<div class='columna_resultado'><div class='opcion_res m-l-20'><input type='text' name='opcion4[]' id='plr"+contLin3+"'></div></div>";
