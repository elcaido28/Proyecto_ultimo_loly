    ...
    <div class="wrap-login600 p-l-55 p-r-55 p-t-65 p-b-54 formu_grande">
      <!-- <form class="login100-form validate-form" method="post" action="" name="formix" id="formix"onsubmit=" return fun_insertar()"> -->
        ...
        <!--abrir formulario cuando inicia sesion-->
            ...
            <input style="display: none;" type="text" id="tiposec" name="tiposeccion[]" value="secrecion">
                        ...
                        <div class="columna_resultado">
                            <div class="opcion_res m-l-18">
                                <select name="resultado[]" id="tiposecrecion" required>
                                    ...
                                    <option value="Vaginal">Uretral</option>
                                    <option value="Vaginal">Faringea</option>
                                    <option value="Vaginal">Purulenta</option>
...
function agregar2() {
  ...
  b2 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res m-l-2'><input type='text' name='opcion3[]' id='pr"+contLin2+"'></div></div>";

  b2 += "<div class='columna_resultado'><div class='opcion_res m-l-20'><input type='text' name='opcion3[]' id='prr"+contLin2+"'></div></div>";
  ...
  if(contLin3>1){
    var conj=parseInt(contLin3)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajatd='an'+i;
            cont_valor[m]=document.getElementById(idcajatd).value;
            
            var idcajatdd='ant'+i;
            cont_valorr[m]=document.getElementById(idcajatdd).value;
        }
    }

  b3 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='an"+contLin3+"'></div></div>";

  b3 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='ant"+contLin3+"'></div></div>";
  ...
  b3 = contenidog3 + b3;
    ...
    if(contLin3>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajatd='an'+j;
            document.getElementById(idcajatd).value=cont_valor[m];
      
            var idcajatdd='ant'+j;
            document.getElementById(idcajatdd).value=cont_valorr[m];
        }
    }
        ...
        for (var j=0; j<formularios[i].elements.length-2; j++){
            ...
            if (j!=13 && j!=15) {
                ...
                if (contenido=="") {
                    ...
                    msg = msg + '\n\nElemento '+j+ ' tiene id: '+ formularios[i].elements[j].id;
