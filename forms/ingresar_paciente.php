    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container" >
        <div class="banner_content text-left">
          <h2 style="color: #000000">Ingresar Paciente</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_paciente.php">Ingresar Paciente</a>
          </div>
        </div>
      </div>
    </div>
        ...
        title: 'Fecha Incorrecta'
          ...
          <div class="parados m-b-20">
            <div class="wrap-input100 validate-input m-b-23 m-r-20" data-validate = "Nombre es requerido">
              ...
              <input class="input100" type="text" name="celular" id="celular" maxlength="10" required placeholder="Ej: 0912345678" onchange="validarCelular()" onkeypress="return valida(event)">
              <span class="focus-input100" data-symbol="&#xf2d7;"></span>
            </div>
            <div class="wrap-input100 validate-input m-b-23 m-r-20" data-validate = "Nombre es requerido">
              <span class="label-input100">Teléfono</span>
              <input class="input100" type="text" name="telefono" id="telefono" maxlength="7" required placeholder="Ej: 2502729" onchange="validarTelefono()" onkeypress="return valida(event)">
              <span class="focus-input100" data-symbol="&#xf2bb;"></span>
            </div>
            <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
              <span class="label-input100">Correo (*)</span>
              <input class="input100" type="text" name="correo" id="correo" onchange="validarcorreo()" placeholder="Ej: correo@correo.com" required>
              <span class="focus-input100" data-symbol="&#xf15a;"></span>
            </div>
          </div>
