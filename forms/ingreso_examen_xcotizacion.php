...
<?php
  if ($perfil >= 1){
    ...
    $consulta=mysqli_query($con,"SELECT * FROM cabecera_cotizacion CC INNER JOIN paciente P ON CC.id_paciente=P.id_paciente WHERE id_cabecera_cotizacion='$idcab'");
    $row=mysqli_fetch_array($consulta);
    $idpac=$row['id_paciente'];
    $nombres_paciente=$row['nombres']." ".$row['apellidos'];
    ...
    $consulta2=mysqli_query($con,"SELECT * FROM detalle_cotizacion DC INNER JOIN reactivo R ON DC.id_reactivo=R.id_reactivo WHERE id_cabecera_cotizacion='$idcab'");
    
    $examenes= array();

    while ($c = mysqli_fetch_assoc($consulta2)) {
        //var_dump($c);
        $examenes[] = $c['nombre_reactivo'];
    }
?>
<!--================Header Menu Area =================-->
<script>
  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Ingresar Exámen</h2>
        <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="buscar_cotizacion.php">Buscar Cotización</a>
            <a style="color: #000000" href="ingreso_examen_xcotizacion.php?idcc=<?php echo $idcab; ?>">Registrar Exámen</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="container-login100" style="background: #B8E1F7;">
    ...
    <div class="wrap-login600 p-l-55 p-r-55 p-t-65 p-b-54 formu_grande">
      <!-- <form class="login100-form validate-form" method="post" action="" name="formix" id="formix"onsubmit=" return fun_insertar()"> -->
        <form class="login100-form validate-form formulario" method="post" action="app/guardarExamenXcotizacion.php?idp=<?php echo $idpac; ?>&idc=<?php echo $idcab; ?>" name="formix" id="formix">
        <!--abrir formulario cuando inicia sesion-->
            ...
            <div class="parados">
                <div class="col-md-6" data-validate = "Nombre es requerido">
                    ...
                    <p class="input100" style="padding-left: 30px; padding-top: 20px; height: 35px;" readonly> <?php echo $nombres_paciente; ?> </p>
                ...
                <div class="col-md-3" data-validate = "Nombre es requerido">
                    ...
                    <p class="input100" style="padding-left: 25px; padding-top: 20px; height: 35px;" readonly> <?php echo $identificacion_paciente; ?> </p>
                    <span class="focus-input100" data-symbol=""></span>
                    </div>
                </div>
            ...
            <div class="parados">
                ...
                <div class="col-md-3">
                    <div class="wrap-input100 m-b-23 m-r-12">
                        ...
                        <input class="input100" type="text" name="precio" id="precio" onkeypress="return valida(event)" maxlength="6" value="<?php echo $precio; ?>" readonly required>
                        <span class="focus-input100" data-symbol=""></span>
                    </div>
                </div>
                <div class="col-md-2">
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
            ...
            <div class="parados">
                <div class="wrap-input100 m-b-23 m-r-12">
                    ...
                    <input class="input100" type="text" name="tpagoss" id="tpagoss" maxlength="6" placeholder="0" onkeypress="return valida(event)" value="<?php echo $nombre_pago; ?>" readonly>
                    <input class="input100" type="text" name="tpago" id="tpago" maxlength="6" placeholder="0" onkeypress="return valida(event)" value="<?php echo $tipo_pago; ?>" readonly style="display: none;">
                    <span class="focus-input100" data-symbol=""></span>
                </div>
                <div class="wrap-input100 m-b-23">
                    <span class="label-input100" id="titabo">Valor</span>
                    <input class="input100" type="text" name="abono" id="abono" maxlength="6" placeholder="0" onkeypress="return valida(event)" value="<?php echo $abono; ?>" readonly>
                    <span class="focus-input100" data-symbol=""></span>
                </div>
            </div>
<script>
    function tipep(){
        ...
        if (tipoa == 1) {
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Leucocitos', $examenes)){ echo "checked"; } ?> type="checkbox" id="Leucocitos" name="Name[]" value="Leucocitos" >
                <label for="Leucocitos">Leucocitos </label>

                <input <?php if(in_array('Hematócrito', $examenes)){ echo "checked"; } ?> type="checkbox" id="Hemotocrito" name="Name[]" value="Hematócrito" >
                <label for="Hemotocrito">Hematócrito </label>
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('T. Sangría', $examenes)){ echo "checked"; } ?> type="checkbox" id="HT" name="Name[]"name="Name[]" value="T. Sangría">
                <label for="HT">T. Sangría  </label>
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('V.D.R. tantita', $examenes)){ echo "checked"; } ?> type="checkbox" id="VDT" name="Name[]" value="V.D.R.I. tantit">
                <label for="VDT">V.D.R.I. tantit </label>
                ...
                <input <?php if(in_array('R.A. TEST (Turb.)', $examenes)){ echo "checked"; } ?> type="checkbox" id="raTurb" name="Name[]" value="R.A. TEST (Turb.)">
                <label for="raTurb">R.A. TEST (Turb.) </label>
                <input <?php if(in_array('Celulas L.E.', $examenes)){ echo "checked"; } ?> type="checkbox" id="calculasLe" name="Name[]" value="Celulas L.E.">
                <label for="calculasLe">Celulas L.E. </label>
                ...
                <input <?php if(in_array('V.D.R.L cuali', $examenes)){ echo "checked"; } ?> type="checkbox" id="vdrl" name="Name[]" value="V.D.R.L cuali">
                <label for="vdrl">V.D.R.L cuali</label>
                <input <?php if(in_array('V.D.R.L cuant', $examenes)){ echo "checked"; } ?> type="checkbox" id="vdrlct" name="Name[]" value="V.D.R.L cuant">
                <label for="vdrlct">V.D.R.L cuant</label>
            ...
            <div class="checkbox">
                ...
                <input<?php if(in_array('CHE (Colinesterasa)', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="checoli" value="CHE (Colinesterasa)">
                <label for="checoli">CHE (Colinesterasa)</label>
                ...
                <input<?php if(in_array('Fosf. Alcalina', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="fosfalcalina" value="Fosf. Alcalina">
                <label for="fosfalcalina">Fosf. Alcalina</label>
                ...
                <input<?php if(in_array('Fosfat. acid. prost.', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="fosfacidaprostatica" value="Fosfat. acid. prost.">
                <label for="fosfacidaprostatica">Fosfat. acid. prost.</label>
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Seroglobulina', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="Seroglogulina" value="Seroglobulina">
                <label for="Seroglogulina">Seroglobulina</label>
            </div>
            ...
            <div class="checkbox">
                ...
                <!--<input <?php if(in_array('Fosf. Alcalina"', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="Fosfatalcal" value="Fosf. Alcalina">-->
                <!--<label for="Fosfatalcal">Fosf. Alcalina</label>-->
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Urinálisis EMO (F.Q.S.)', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="UrinalisisEMOFQS" value="Urinálisis EMO (F.Q.S.)">
                <label for="UrinalisisEMOFQS">Urinálisis EMO (F.Q.S.)</label>

                <input <?php if(in_array('Albúmina 24h', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="Albumina24h" value="Albúmina 24h">
                <label for="Albumina24h">Albúmina 24h</label>

                <input <?php if(in_array('Albúmina Ocasional', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="AlbuminaOcasional" value="Albúmina Ocasional">
                <label for="AlbuminaOcasional">Albúmina Ocasional</label>
                ...
                <input <?php if(in_array('Embarazo en Orina', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="Embarazo" value="Embarazo en Orina">
                <label for="Embarazo">Embarazo en Orina</label>
                ...
                <input <?php if(in_array('Sodio Ocasional', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="SodioOcacional" value="Sodio Ocasional">
                <label for="SodioOcacional">Sodio Ocasional</label>
                ...
                <input <?php if(in_array('Orina FQS', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="orinafqs" value="Orina FQS">
                <label for="orinafqs">Orina FQS</label>
            </div>
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Oxiuros Tec. Graham', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="OxiuroaTecGraham" value="Oxiuros Tec. Graham">
                <label for="OxiuroaTecGraham">Oxiuros Tec. Graham</label>
            </div>
            ...
            <div class="checkbox">
                ...
                <!--<input <?php if(in_array('Eritrosedimentación', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="entrosedimentacion" value="Eritrosedimentación">-->
                <!--<label for="entrosedimentacion">Eritrosedimentación</label>-->
                ...
                <!--<input <?php if(in_array('Fibrinógeno', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="fibrinogino" value="Fibrinógeno">-->
                <!--<label for="fibrinogino">Fibrinógeno</label>-->
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Calcio Total', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="calcio" value="Calcio">
                <label for="calcio">Calcio</label>
                ...
                <input <?php if(in_array('Calcio Iónico', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="CalcioLonico" value="Calcio Iónico">
                <label for="CalcioLonico">Calcio Iónico</label>
            ...
            <div class="checkbox">
                <h2 style="background-color:#CCEEFF; margin-left: 1px; padding: 5px 10px 5px 15px;">CULTIVOS Y ANTIBIOGRAMAS:</h2>
                <input <?php if(in_array('Coprocultivo', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="coprocultivo" value="Coprocultivo">
                <label for="coprocultivo">Coprocultivo</label>
            ...
            <div class="checkbox">
                ...
                <input <?php if(in_array('Clamidia', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="Clamudia" value="Clamidia">
                <label for="Clamudia">Clamidia</label>
                ...
                <input <?php if(in_array('IgA', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="lga" value="IgA">
                <label for="lga">IgA</label>

                <input <?php if(in_array('IgE', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="lge" value="IgE">
                <label for="lge">IgE</label>
                ...
                <input <?php if(in_array('IgG', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="lgg" value="IgG">
                <label for="lgg">IgG</label>

                <input <?php if(in_array('IgM', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="lgm" value="IgM">
                <label for="lgm">IgM</label>
                ...
                <input <?php if(in_array('Transferrina', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="transferina" value="Transferrina">
                <label for="transferina">Transferrina</label>

                <input <?php if(in_array('Transferrina Saturación', $examenes)){ echo "checked"; } ?> type="checkbox" name="Name[]" id="transferinas" value="Transferrina Saturación">
                <label for="transferinas">Transferrina Saturación</label>
            ...
            <div class="container-login100-form-btn">
              ...
              <div class="wrap-login40-form-btn-aceptar">
                ...
                <div class="wrap-login40-form-btn-cancelar">
                    ...
                    <a href="buscar_cotizacion.php" class="txt2">
