    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">Editar Cargo</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_cargo.php">Agregar Cargo</a>
            <a style="color: #000000" href="editar_cargo.php?idr=<?php echo $id_rol; ?>">Editar Cargo</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="margin-top: -180px;">
        <form class="login100-form validate-form" method="post" action="app/modificarRol.php?idr=<?php echo $id_rol; ?>" name="formix" id="formix">   <!--abrir formulario cuando inicia sesion-->
          ...
          <div class="wrap-input100 validate-input m-b-23" data-validate = "Nombre es requerido">
            ...
            <input class="input100" type="text" name="rol" id="rol" value="<?php echo $row['nombre_rol']; ?>" placeholder="Ej: Empleado" required>
