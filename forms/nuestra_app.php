		...
		<div class="container">
			<div class="row justify-content-center section-title-wrap" style="margin-bottom: 10px;">
				<div class="col-lg-10">
					...
					<img src="images/diseño3.png" alt="">
					<p>
			...
			<div class="row">
				...
				<div class="col-lg-4">
				    ...
				    <div id="qrcode" style="display: flex; flex-wrap: wrap; justify-content: center;align-items: center;">
				        <img src="../img/qr-code.png" alt="Generador de Códigos QR Codes" width="400" heigth="400"/>
                        <!--<img src="https://www.codigos-qr.com/qr/php/qr_img.php?d=http%3A%2F%2Flaboratoriololy.com%2Fforms%2Fdescargas%2FappLoly.apk&s=6&e=m" alt="Generador de Códigos QR Codes"/>-->
                        <br/>
                        <p>...O da Click <a href="http://laboratoriololy.com/forms/descargas/appLoly.apk" target="_blank" id="qrgenerator">Aquí</a> para descargar</p>
                    </div>
