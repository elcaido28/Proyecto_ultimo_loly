    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content text-left">
          <h2 style="color: #000000">Editar Usuario</h2>
          <div class="page_link">
            <a style="color: #000000" href="inicio.php">Inicio</a>
            <a style="color: #000000" href="ingresar_empleado.php">Ingresar Empleado</a>
            <a style="color: #000000" href="asignar_usuario.php?ide=<?php echo $id_emp; ?>">Asignar Usuario</a>
            <a style="color: #000000" href="editar_usuario.php?idu=<?php echo $id_usu; ?>">Editar Usuario</a>
          </div>
        </div>
      </div>
    </div>
