...
function agregar() {
  ...
  b += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res m-l-4'><input type='text' name='opcion2[]' id='pl"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion2[]' id='pll"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res m-l-33'><input type='text' name='opcion2[]' id='plll"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res m-l-20'><input type='text' name='opcion2[]' id='pllll"+contLin+"' style='width: 98px; padding-left: 13px; width: 100px;'></div></div></div><br>";
...
function agregar2() {
  ...
  if(contLin2>1){
    var conj=parseInt(contLin2)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idt='pr'+i;
            cont_valor[m]=document.getElementById(idt).value;
            
            var idtr='prr'+i;
            cont_valorr[m]=document.getElementById(idtr).value;
            
            var idtrr='prrr'+i;
            cont_valorrr[m]=document.getElementById(idtrr).value;
            
            var idtrrr='prrrr'+i;
            cont_valorrrr[m]=document.getElementById(idtrrr).value;
        }
    }
  ...
  b2 += "<div class='columna_resultado'><div class='opcion_res m-l-30'><input type='text' name='opcion3[]' id='prrr"+contLin2+"'></div></div>";

  b2 += "<div class='columna_resultado'><div class='opcion_res m-l-30'><input type='text' name='opcion3[]' id='prrrr"+contLin2+"'></div></div></div><br>";
  ...
  contenidog2 = document.getElementById('contenidos2').innerHTML;
    ...
    if(contLin2>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idt='pr'+j;
            document.getElementById(idt).value=cont_valor[m];
      
            var idtr='prr'+j;
            document.getElementById(idtr).value=cont_valorr[m];
            
            var idtrr='prrr'+j;
            document.getElementById(idtrr).value=cont_valorrr[m];
            
            var idtrrr='prrrr'+j;
            document.getElementById(idtrrr).value=cont_valorrrr[m];
        }
    }
  ...
  if(contLin3>1){
    var conj=parseInt(contLin3)-1;
        for (var i=1; i <=conj; i++){
            ...
            var idcajattt='ppp'+i;
            cont_valorrr[m]=document.getElementById(idcajattt).value;
        }
    }

  b3 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='p"+contLin3+"'></div></div>";

  b3 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='pp"+contLin3+"'></div></div>";

  b3 += "<div class='columna_resultado'><div class='opcion_res m-l-12'><input type='text' name='opcion4[]' id='ppp"+contLin3+"' style='width: 95px;'></div></div>";
  ...
  b3 = contenidog3 + b3;
    ...
    if(contLin3>1){
        ...
        for (var j=1; j <=conj; j++){
            ...
            var idcajadttt='ppp'+j;
            document.getElementById(idcajadttt).value=cont_valorrr[m];
        }
    }
...
function borrarUltima3() {
  ...
  if(contenidog3 != ''){
    ...
    for (var j=1; j <=conj; j++){
        ...
        var idcajattt='ppp'+j;
        document.getElementById(idcajattt).value=cont_valorrr[m];
    }
