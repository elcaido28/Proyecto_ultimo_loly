                            ...
                            <div class="columna_resultado">
                                <div class="opcion_res m-l-30">
                                    <select name="opcion[]" id="gl3" value="">
                                        <option value="">-</option>
                                        <option value="30 a 60">70 a 110</option>
                                        <option value="70 a 100">150 a 200</option>
                                        <option value="110 a 130">60 a 150</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
function agregar() {
  ...
  var cont_valorrrr=[];
  if(contLin>1){
    var conj=parseInt(contLin)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajadt='pl'+i;
            cont_valor[m]=document.getElementById(idcajadt).value;
            
            var idcajadtr='pll'+i;
            cont_valorr[m]=document.getElementById(idcajadtr).value;
            
            var idcajadtrr='plll'+i;
            cont_valorrr[m]=document.getElementById(idcajadtrr).value;
            
            var idcajadtrrr='pllll'+i;
            cont_valorrrr[m]=document.getElementById(idcajadtrrr).value;
        }
    }

  b += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion2[]' id='pl"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion2[]' id='pll"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res m-l-40'><input type='text' name='opcion2[]' id='plll"+contLin+"'></div></div>";

  b += "<div class='columna_resultado'><div class='opcion_res m-l-15'><input type='text' name='opcion2[]' id='pllll"+contLin+"' style='width: 98px;'></div></div></div><br>";
  ...
  b = contenidog + b;
    ...
    if(contLin>1){
        var conj=parseInt(contLin)-1;
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajadt='pl'+j;
            document.getElementById(idcajadt).value=cont_valor[m];
      
            var idcajadtr='pll'+j;
            document.getElementById(idcajadtr).value=cont_valorr[m];
            
            var idcajadtrr='plll'+j;
            document.getElementById(idcajadtrr).value=cont_valorrr[m];
            
            var idcajadtrrr='pllll'+j;
            document.getElementById(idcajadtrrr).value=cont_valorrrr[m];
        }
    }
...
function agregar2() {
  ...
  var cont_valorr=[];
  if(contLin2>1){
    var conj=parseInt(contLin2)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajat='pr'+i;
            cont_valor[m]=document.getElementById(idcajat).value;
            
            var idcajatt='prr'+i;
            cont_valorr[m]=document.getElementById(idcajatt).value;
        }
    }

  b2 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion3[]' id='pr"+contLin2+"'></div></div>";

  b2 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion3[]' id='prr"+contLin2+"'></div></div>";
  ...
  b2 = contenidog2 + b2;
    ...
    if(contLin2>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajat='pr'+j;
            document.getElementById(idcajat).value=cont_valor[m];
      
            var idcajatt='prr'+j;
            document.getElementById(idcajatt).value=cont_valorr[m];
        }
    }
...
function agregar3() {
  ...
  var cont_valorr=[];
  if(contLin3>1){
    var conj=parseInt(contLin3)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajad='pt'+i;
            cont_valor[m]=document.getElementById(idcajad).value;
            
            var idcajadd='ptt'+i;
            cont_valorr[m]=document.getElementById(idcajadd).value;
        }
    }

  b3 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='pt"+contLin3+"'></div></div>";

  b3 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion4[]' id='ptt"+contLin3+"'></div></div>";
  ...
  b3 = contenidog3 + b3;
    ...
    if(contLin3>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajad='pt'+j;
            document.getElementById(idcajad).value=cont_valor[m];
      
            var idcajadd='ptt'+j;
            document.getElementById(idcajadd).value=cont_valorr[m];
        }
    }
...
function agregar4() {
  ...
  var cont_valorr=[];
  if(contLin4>1){
    var conj=parseInt(contLin4)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajas='se'+i;
            cont_valor[m]=document.getElementById(idcajas).value;
            
            var idcajass='sed'+i;
            cont_valorr[m]=document.getElementById(idcajass).value;
        }
    }

  b4 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion5[]' id='se"+contLin4+"'></div></div>";

  b4 += "<div class='columna_resultado'><div class='opcion_res'><input type='text' name='opcion5[]' id='sed"+contLin4+"'></div></div>";
  ...
  b4 = contenidog4 + b4;
    ...
    if(contLin4>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajas='se'+j;
            document.getElementById(idcajas).value=cont_valor[m];
      
            var idcajass='sed'+j;
            document.getElementById(idcajass).value=cont_valorr[m];
        }
    }
...
function agregar5() {
  ...
  var cont_valorr=[];
  if(contLin5>1){
    var conj=parseInt(contLin5)-1;
        for (var i=1; i <=conj; i++){
            var m=parseInt(i)-1;
            var idcajatc='mi'+i;
            cont_valor[m]=document.getElementById(idcajatc).value;
            
            var idcajatcc='mic'+i;
            cont_valorr[m]=document.getElementById(idcajatcc).value;
        }
    }

  b5 += "<div class='contenedor_nuevo'><div class='columna_resultado'><div class='opcion_res m-l-3'><input type='text' name='opcion6[]' id='mi"+contLin5+"'></div></div>";

  b5 += "<div class='columna_resultado'><div class='opcion_res m-l-25'><input type='text' name='opcion6[]' id='mic"+contLin5+"'></div></div>";
  ...
  b5 = contenidog5 + b5;
    ...
    if(contLin5>1){
        ...
        for (var j=1; j <=conj; j++){
            var m=parseInt(j)-1;
            var idcajatc='mi'+j;
            document.getElementById(idcajatc).value=cont_valor[m];
      
            var idcajatcc='mic'+j;
            document.getElementById(idcajatcc).value=cont_valorr[m];
        }
    }
    ...
    // }else{
        ...
        const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                  title: 'Guardar Datos?',
                  text: "Una vez guardados los datos, no se podrán editar !",
                  icon: 'question',
