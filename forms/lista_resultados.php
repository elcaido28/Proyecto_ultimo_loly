  ...
  <div class="banner_inner d-flex align-items-center">
    <div class="container" >
      <div class="banner_content text-left">
        <h2 style="color: #000000">Lista de Resultados</h2>
        <div class="page_link">
          <a style="color: #000000" href="inicio.php">Inicio</a>
          <a style="color: #000000" href="buscar_resultados.php">Buscar Resultados</a>
          <a style="color: #000000" href="lista_resultados.php?idc=<?php echo $idcab; ?>&idp=<?php echo $idpac; ?>">Lista de Resultados</a>
        </div>
      </div>
    </div>
  </div>
